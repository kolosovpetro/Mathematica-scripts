...
UnitTest1::usage= "Performes Unit test 1 from source https://github.com/KolosovPetro/research_unit_tests"
UnitTest2::usage= "Performes Unit test 2 from source https://github.com/KolosovPetro/research_unit_tests"
UnitTest3::usage= "Performes Unit test 3 from source https://github.com/KolosovPetro/research_unit_tests"
UnitTest4::usage= "Performes Unit test 4 from source https://github.com/KolosovPetro/research_unit_tests"
UnitTest5::usage= "Performes Unit test 5 from source https://github.com/KolosovPetro/research_unit_tests"
UnitTest6::usage= "Performes Unit test 6 from source https://github.com/KolosovPetro/research_unit_tests"
UnitTest7::usage= "Performes Unit test 7 from source https://github.com/KolosovPetro/research_unit_tests"
UnitTest8::usage= "Performes Unit test 8 from source https://github.com/KolosovPetro/research_unit_tests"
UnitTest9::usage= "Performes Unit test 9 from source https://github.com/KolosovPetro/research_unit_tests"
UnitTest10::usage= "Performes Unit test 10 from source https://github.com/KolosovPetro/research_unit_tests"
UnitTest11::usage= "Performes Unit test 11 from source https://github.com/KolosovPetro/research_unit_tests"
UnitTest12::usage= "Performes Unit test 12 from source https://github.com/KolosovPetro/research_unit_tests"
UnitTest13::usage= "Performes Unit test 13 from source https://github.com/KolosovPetro/research_unit_tests"
...
UnitTest1 := Column[Table[FullSimplify[P[m,t,a,b] == P[m,t,0,b]-P[m,t,0,a]],{m,0,10},{t,0,10}], Left];
UnitTest2 := Column[Table[FullSimplify[P[m,t,a,b] == Sum[(-1)^(m-j) X[m,j,a,b] t^j,{j,0,m}]],{m,0,3},{t,0,10}],Left];
UnitTest3 := Column[Table[FullSimplify[X[m,t,a,b] == X[m,t,0,b]-X[m,t,0,a]],{m,0,10},{t,0,10}], Left];
UnitTest4 := Column[Table[FullSimplify[X[m,t,a,b] == (-1)^m Sum[H[m,t,k]*(b^k-a^k),{k,1,2 m-t+1}]],{m,0,10},{t,0,10}], Left];
UnitTest5 := Column[Table[FullSimplify[P[m,t,a,b] == Sum[(-1)^(m-j) (-1)^m Sum[H[m,j,k]*(b^k-a^k),{k,1,2 m-j+1}] t^j,{j,0,m}]],{m,0,10},{t,0,10}], Left];
